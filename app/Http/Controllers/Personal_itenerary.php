...
class Personal_itenerary extends Controller
{
    ...
    function create_charge_breakdown($charge_id,$charge,$additional_charge,$drivers_overtime_charge,$overtime,$total){
            ...
            try{
                ...
                $this->pdoObject=DB::connection()->getPdo();
                #begin transaction   
                $insert_sql="INSERT INTO trp_charge_breakdown(charge_id,charge,additional_charge,drivers_overtime_charge,overtime,total)values(:charge_id,:charge,:additional_charge,:drivers_overtime_charge,:overtime,:total)";
