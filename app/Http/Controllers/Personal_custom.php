...
class Personal_custom extends Controller
{
    /**
   ...
   public function create(Request $request)
    {
        ...
        if(!empty($id)&&!empty($full_name)&&!empty($token)){
           ...
           try{
                ...
                $insert_sql="INSERT INTO trp_cust_passengers(trp_id,full_name,designation)values(:tr_id,:full_name,:designation)";
    ...
    public function destroy($id)
    {
        try{
            ...
            $this->id=htmlentities(htmlspecialchars($id));
            $this->pdoObject->beginTransaction();
            $remove_rfp_sql="DELETE FROM trp_cust_passengers where id=:id";
