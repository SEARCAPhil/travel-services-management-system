      ...
      <div class="col col-md-5 col-sm-5 col-sm-offset-4 col-md-offset-4">
        ...
        <center><img src="img/maintenance.png" width="40%"></center>
  		...
  		<form  class="form col col-md-10 col-sm-10 col-sm-offset-1 col-md-offset-1 text-left" id="form">
            <label>Specify Item(s) to repair <small class="text-danger">(* Required)</small></label> <input type="text" class="form-control" id="item">
            ...
            <label>Receipt Number</label> <input type="text" class="form-control" id="receipt_number">
              <label>Repair Shop</label> <input type="text" class="form-control" id="supplier"><br><br>
