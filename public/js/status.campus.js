/**
* STATUS UPDATE SCRIPT FOR CAMPUS TRAVEL REQUEST
...
function forwardCampusTravelRequest(){
	...
	$('.modal-submit').on('click',function(){
	    ...
	    //ajax here
	    ajax_updateTravelStatusPreview('api/travel/campus/status/',$(selectedElement).attr('id'),1,function(data){
	    	...
	    	if(data==1){
	    		...
	    		if(isAdmin()){
					...
					setTimeout(function(){
						bindReturnCampus()
						bindVerifyCampus()
						disableStatusDefaultButtonCommandGroup()
					},1000)
...
function verifyCampusTravelRequest(id){
	...
	$('.modal-submit').on('click',function(){
	    ...
	    $(this).attr('disabled','disabled')
 		...
 		ajax_updateTravelStatusPreview('api/travel/campus/status/',$(selectedElement).attr('id'),2,function(data){
...
function returnCampusTravelRequest(){
	...
	$('.modal-submit').on('click',function(){
	    ...
	    ajax_updateTravelStatusPreview('api/travel/campus/status/',$(selectedElement).attr('id'),3,function(data){
...
function closeCampusTravelRequest(){
	...
	$('.modal-submit').on('click',function(){
	    ...
	    ajax_updateTravelStatusPreview('api/travel/campus/status/',$(selectedElement).attr('id'),4,function(data){
...
function bindVerifyCampus(){
	...
	$('.preview-verify').on('click',function(){
			...
			showBootstrapDialog('#preview-modal','#preview-modal-dialog','travel/modal/verify',function(){
				//verify
				verifyCampusTravelRequest()

			})
	})
}

function bindForwardCampus(){
...
function disableStatusDefaultButtonCommandGroup(){
	$('.preview-remove').addClass('disabled');
